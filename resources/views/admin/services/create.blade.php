    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex  m-2 p-2">
               <a href="{{route('admin.services.index')}}" class="px-2 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Voir Les Services</a>
            </div>
